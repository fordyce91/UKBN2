...
<?php if (!empty($resetToken)): ?>
    <form method="POST" action="/password/reset" class="space-y-4">
        ...
        <div>
            ...
            <input class="mt-1 w-full rounded-md border border-slate-300 px-3 py-2 text-slate-900 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-200" type="password" id="password" name="password" minlength="6" required>
        </div>
